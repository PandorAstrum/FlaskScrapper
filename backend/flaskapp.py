...
from backend.helpers.scrapper import login, get_driver, get_likers, get_profile_like, close, get_commenters
from backend.helpers.generic_helpers import get_curr_date_time, JSONEncoder, allowed_file
from backend.helpers.csv_helpers import readCSV
from backend.helpers.generic_helpers import ListConverter
...
def index():
    ...
    return render_template('index2.html', _job_data=_all_jobs_document, _user_data=_all_users_document)
